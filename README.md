...
```shell
pip install --force-reinstall git+https://gitee.com/cyfney/py_clogger.git@v1.0.3
```

Alternatively, you can install the library directly from the GitHub repository:

```shell
pip install --force-reinstall git+https://github.com/cyfney/py_clogger.git@v1.0.3
```
